...
// // Add this click event for decrementing item quantity
...
//     let cartItem = cart.find(cartItem => cartItem.item.id === itemId);
//     if (cartItem) {
//         cartItem.quantity++;
//         updateCartItemQuantity(itemId, cartItem.quantity);
//         console.log("Item quantity incremented:", cartItem);
//     }
// }
...
//         cartItem.quantity--;
//         updateCartItemQuantity(itemId, cartItem.quantity);
//         console.log("Item quantity decremented:", cartItem);
//     }
// }